...
for epoch in range(epochs):
    ...
    save_path = 'save_models/DAT_best_davis_1e-3_256_protein_cold.pkl'
    mse_save_path = 'saved_models/DAT_best_davis_mse_1e-3_256_protein_cold.pkl'
    if all_ci > best_ci:
        best_ci = all_ci
        model.cpu()
